...
TARGET_RECOVERY_UI_LIB := librecovery_ui_loki
TARGET_RECOVERY_FSTAB = device/nvidia/platform/loki/t124/fstab.loki

BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR ?= device/nvidia/platform/loki/t124/bluetooth
...
#Shutdown on charge complete, from charging loop
BOARD_CHARGER_DISABLE_INIT_ANIM := true

#Use tegra health HAL library
BOARD_HAL_STATIC_LIBRARIES := libhealthd.tegra

#Mount filesystem to ensure gpu firmware is loaded
BOARD_CHARGER_MOUNT_FILE_SYSTEM := true
...
BOARD_SEPOLICY_DIRS += device/nvidia/platform/loki/t124/sepolicy/
else
# AOSP master based board specific sepolicy
BOARD_SEPOLICY_DIRS += device/nvidia/platform/loki/t124/sepolicy_aosp/
endif
