...
mkdir -p $OUT/nvtest_ramdisk_tmpdir/system/vendor/lib64/lua
mkdir -p $OUT/nvtest_ramdisk_tmpdir/system/vendor/lib64/lua/5.1
cd $OUT/nvtest_ramdisk_tmpdir/system/vendor/lib64/lua/5.1
cp $OUT/system/vendor/lib64/lua/5.1/* .
