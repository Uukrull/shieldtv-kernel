...
static int __init init_dvbdev(void)
{
	...
	printk(KERN_ERR "WARNING: You are using an experimental version of the media stack.\n\tAs the driver is backported to an older kernel, it doesn't offer\n\tenough quality for its usage in production.\n\tUse it with care.\nLatest git patches (needed if you report a bug to linux-media@vger.kernel.org):\n\ta73cfe527c10bb023f0e22dd8cf37dd418c093e7 [media] msi2500: Delete an unnecessary check in msi2500_set_usb_adc()\n\t61f8e1a73296d065abc959e0c0861ffbdfa2d0b3 [media] r820t: Delete an unnecessary variable initialisation in generic_set_freq()\n\t2050d14c6ea23ea7b50b5cc7d05dbf645705cf70 [media] tuners: Refactoring for m88rs6000t_sleep()\n");
